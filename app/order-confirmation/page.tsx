...
export default function OrderConfirmationPage() {
  ...
  const orderId = lastOrder?.orderId || '#TZ10284';
  ...
  return (
    <div className="bg-black text-white min-h-[85vh] font-inter flex flex-col justify-between selection:bg-white selection:text-black">
      ...
      <div className="max-w-[1440px] w-full mx-auto px-6 lg:px-10 py-16 flex-1 flex flex-col items-center justify-center text-center space-y-12">
