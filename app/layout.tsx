  ...
  return (
    <html lang="en" className="h-full bg-black text-white antialiased">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Inter:wght@300;400;500;600;700;900&family=Lexend+Tera:wght@300;400;600;700&family=Cinzel:wght@600;800;900&display=swap"
          rel="stylesheet"
        />
      </head>
